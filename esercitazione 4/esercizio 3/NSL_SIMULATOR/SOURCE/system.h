...
public: // Function declarations
  int get_npart();            // Get the number of particles
  ...
  void write_U_and_T(vec U, vec T, unsigned int nblock);       // Write in UT.dat file the values of U and T
  ...
  void invert_time();         // Invert velocities of each particle
  ...
  double get_U();             // Get potential energy
  double get_T();             // Get temperature
