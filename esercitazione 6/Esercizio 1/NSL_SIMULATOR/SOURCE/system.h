...
private:
  ...
  int _index_penergy, _index_kenergy, _index_tenergy, _index_E1, _index_E2;       // Indices for accessing energy-related properties in vec _measurement
  ...
  vector<double> _cv, _M, _U, _chi;     // Vectors in which the result and the relative error are stored
