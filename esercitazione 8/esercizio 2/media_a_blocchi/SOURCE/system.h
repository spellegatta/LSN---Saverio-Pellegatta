...
private:
  ...
  unsigned int _n_bins_psi;
  double _bin_size_psi, _appo_psi;
  bool _measure_H_av,_measure_penergy, _measure_kenergy,  _measure_psi      ;// Flags for measuring average energy, potential energy and kinetic energy
  int _index_H_av, _index_penergy, _index_kenergy, _index_psi;       // Indices for accessing average energy, potential energy and kinetic energy in vec _measurement
